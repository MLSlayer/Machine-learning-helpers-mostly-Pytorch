...
output_padding_height = int(input('what is the ouput padding height?'))
output_padding_width = int(input('what is the ouput padding width?'))

height_out = (height - 1) * stride_height - 2 * padding_height + dilation_height * (kernel_height - 1) + output_padding_height + 1
width_out = (width - 1) * stride_width - 2 * padding_width + dilation_width * (kernel_width - 1) + output_padding_width + 1
